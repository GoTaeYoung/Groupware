...
function goStartMode() {
	...
	if (sSrc.indexOf("btn_confirm2.png") < 0) {
		welBtnConfirm.attr("src",
				"resources/SEditor/img/photoQuickPopup/btn_confirm2.png");
...
function goReadyMode() {
	...
	if (sSrc.indexOf("btn_confirm2.png") >= 0) {
		...
		welBtnConfirm.attr("src",
				"resources/SEditor/img/photoQuickPopup/btn_confirm.png");
	}
}
	...
	if (!!bExceedLimitTotalSize) {
		...
		aFileList
				.push('	<a onclick="delImage(\'img'
						+ nImageInfoCnt
						+ '\')"><img class="del_button" src="resources/SEditor/img/photoQuickPopup/btn_del.png"  width="14" height="13" alt="첨부 사진 삭제"></a>');
		aFileList.push('	</li> ');
...
function callFileUploader() {
	oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"), {
		sUrl : '/photoUpload?textAreaName=' + textAreaName, // 샘플 URL입니다.
		sCallback : '/resources/SEditor/photo_uploader/popup/callback.html', // 업로드
		// 이후에
		// iframe이
		// redirect될
		// 콜백페이지의
