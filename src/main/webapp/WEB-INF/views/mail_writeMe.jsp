...
<body>
	...
	<form id="container" enctype="multipart/form-data" method="post">
		<div class="subBtn">
			<input type="button" name="send" onclick="go('mail_my')" value="보내기">
			<input type="button" name="new" onclick="go('mail_writeMe')" value="새로쓰기">
		</div>
		<div>
		...
		<div>
			...
			<input type="text" name="receiver" id="receiver" value="${USER_NAME} (${USER_MAIL})" readonly="readonly">
		</div>
		<div id="fileSpace">
			<div id="fileTop">
				<label>첨부파일</label>
